...
static void paint_document_window_settings_save      (PaintDocumentWindow *self);
static void paint_document_window_size_allocate      (GtkWidget *self, int width, int height, int baseline);
static void paint_document_window_surface_changed    (GdkSurface *surface, GParamSpec *pspec, gpointer user_data);
static void paint_document_window_surface_connect    (GtkWidget *self);
...
{
	paint_document_window_settings_load (self);
	paint_document_window_settings_apply (self);
}
...
{
	return g_object_new (PAINT_TYPE_DOCUMENT_WINDOW, PROPERTY_APPLICATION, application, PROPERTY_SHOW_MENUBAR, TRUE, NULL);
}
...
*/
static void
paint_document_window_settings_apply (PaintDocumentWindow *self)
{
	GtkWindow *window;
...
*/
static void
paint_document_window_settings_load (PaintDocumentWindow *self)
{
	GSettings *settings;
...
*/
static void
paint_document_window_settings_save (PaintDocumentWindow *self)
{
	GSettings *settings;
	settings = paint_get_settings ();
...
*/
static void
paint_document_window_surface_changed (GdkSurface *surface, GParamSpec *pspec, gpointer user_data)
{
...
*/
static void
paint_document_window_surface_connect (GtkWidget *self)
{
	GdkSurface *surface;
	surface = gtk_native_get_surface (GTK_NATIVE (self));
	g_signal_connect (surface, SIGNAL_NOTIFY_STATE, G_CALLBACK (paint_document_window_surface_changed), self);
}
...
*/
static void
paint_document_window_surface_disconnect (GtkWidget *self)
{
	GdkSurface *surface;
	surface = gtk_native_get_surface (GTK_NATIVE (self));
	g_signal_handlers_disconnect_by_func (surface, paint_document_window_surface_changed, self);
}
...
{
	paint_document_window_surface_disconnect (self);
